...
bool Othello::UI::Main::AGL_loadTexture( GLuint& texture, std::string path ) {
	BITMAP *tex;
...
bool MenuRectangle::loadBackTexture( std::string path ) {
...
void Allegro::error( std::string message ) {
	before = clock() - 1;
